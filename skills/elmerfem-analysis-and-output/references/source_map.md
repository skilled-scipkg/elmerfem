# elmerfem source map: Analysis and Output
...
- `elmerice/Solvers/OutputStrainHeating.F90` | score: 17 | matched tokens: elmerice, output, outputstrainheating, solvers
- `elmerice/Solvers/UGridDataReader.F90` | score: 15 | matched tokens: elmerice, solvers, ugriddatareader
- `elmerice/Solvers/Scalar_OUTPUT_Glacier.F90` | score: 15 | matched tokens: elmerice, output, solvers
- `elmerice/Solvers/Permafrost/Permafrost_solid.F90` | score: 15 | matched tokens: elmerice, solid, solvers
- `elmerice/Solvers/OutPutSolvers/XIOSOutputSolver.F90` | score: 14 | matched tokens: elmerice, output, solvers, xios
...
- `elmerice/Solvers/Covarianceutils/BackgroundErrorCostSolver.F90` | score: 10 | matched tokens: elmerice, solvers
