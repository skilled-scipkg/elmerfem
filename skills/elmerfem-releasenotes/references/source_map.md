# elmerfem source map: Releasenotes
...
- `fem/src/ElmerSolver.F90` | score: 34 | matched tokens: elmersolver, release, runtime, solver
- `fem/src/modules/ShellSolver.F90` | score: 30 | matched tokens: fem, release, shell, solver
- `elmerice/Solvers/SSASolver.F90` | score: 29 | matched tokens: elmerice, release, ssa, solver
- `elmerice/Solvers/GridDataReader/GridDataReader.F90` | score: 28 | matched tokens: elmerice, griddatareader, release, solver
- `elmerice/Solvers/OutPutSolvers/XIOSOutputSolver.F90` | score: 27 | matched tokens: elmerice, output, release, xios
- `elmergrid/src/egparallel.c` | score: 24 | matched tokens: elmergrid, parallel, release
